...
{
	sclHard hardware;
	sclSoft software_bmse;
	sclSoft software_bmser;
	sclSoft software_bmse2;
	sclSoft software_mulsum;
	sclSoft software_mulsumfc;
	sclSoft fl_comp_mse;
	sclSoft software_upsl;
	sclSoft software_upslr;
	sclSoft software_uwirpr;
	sclSoft memsetcl;
	sclSoft fillinput;
	sclSoft software_mulsumall_fc;
	sclSoft software_mulsumall_fc_fst;
	sclSoft software_mulsumall_fc_lst;
	sclSoft software_mulsumall_fc_bth;
	sclSoft software_bmseall;
	cl_mem weightscl;
	cl_mem error_begincl;
	cl_mem error_it_cl;
	cl_mem train_slopescl;
	cl_mem prev_steps;
	cl_mem prev_train_slopes;
	cl_mem neurons;
	cl_mem input;
	cl_mem allinputcl;
	cl_mem outpl;
	cl_mem bias_r;
	cl_mem desired_output;
	cl_mem cmse_offset;
	cl_mem MSE_values;
	cl_mem num_bit_fail;
	cl_mem bit_fail_limit;
	cl_mem rprop_increase_factor;	/*1.2; */
	cl_mem rprop_decrease_factor;	/*0.5; */
	cl_mem rprop_delta_min;	/*0.0; */
	cl_mem rprop_delta_max;	/*50.0; */
	cl_mem ncl_cl;
	cl_mem snpl_cl;
	cl_mem tmp_errors;
	cl_mem alllconns;
	...
	cl_mem gk;
	cl_event event;
	fann_type  *MSE_valuesm;
	fann_type  *error_beginclm;
	short  setsinput;
	size_t allinput_offset;
	size_t alloutput_offset;
	size_t mn;
	size_t mc;
	size_t mcr;
	size_t gs;
...
struct fann
{
	...
	unsigned int tc_in_layers;
	unsigned int *consub1stcon;
	unsigned int *alllconns;
	unsigned int *tmp_errors;
