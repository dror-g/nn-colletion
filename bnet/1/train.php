...
#$ann = fann_create_standard(3, fann_num_input_train_data($data),156, fann_num_output_train_data($data));
$ann = fann_create_sparse(0.4, 3, fann_num_input_train_data($data),32, fann_num_output_train_data($data));
...
fann_train_on_data($ann, $data, 2000000, 10, 0.0000000004) or die;
