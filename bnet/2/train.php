...
$data = fann_read_train_from_file("100_1out.txt");
fann_scale_input_train_data($data, 0.0, 0.9);
fann_scale_output_train_data($data, 0.0, 0.9);
...
#$ann = fann_create_standard(3, fann_num_input_train_data($data),102, fann_num_output_train_data($data));
$ann = fann_create_sparse(0.7, 3, fann_num_input_train_data($data),102, fann_num_output_train_data($data));
...
fann_train_on_data($ann, $data, 2000000, 10, 0.000001) or die;
