...
int main()
{
	...
	train_data = fann_read_train_from_file("reverse-5K-splt39output4.txt");
	test_data = fann_read_train_from_file("reverse-5K-splt39output4.txt");
	...
	fann_save(ann, "cascade_comp14.net");
