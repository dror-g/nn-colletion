...
int main()
{
	...
	train_data = fann_read_train_from_file("reverse-5K-10-312.txt");
	test_data = fann_read_train_from_file("reverse-5K-10-312.txt");
	...
	fann_save(ann, "cascade_comp10-312.net");
