...
int main()
{
	...
	train_data = fann_read_train_from_file("reverse-5K-10-1248.txt");
	test_data = fann_read_train_from_file("reverse-5K-10-1248.txt");
	...
	fann_save(ann, "cascade_comp10-1248.net");
