...
int main()
{
	...
	train_data = fann_read_train_from_file("reverse-5K.txt");
	test_data = fann_read_train_from_file("reverse-5K.txt");
	...
	//ann = fann_create_standard(3, fann_num_input_train_data(train_data), 244, fann_num_output_train_data(train_data));
	ann = fann_create_standard(3, fann_num_input_train_data(train_data), 201, fann_num_output_train_data(train_data));
	...
	fann_train_on_data(ann, train_data, 1000, 50, desired_error);
